...
## [](https://huggingface.co/learn/agents-course/en/unit1/agent-steps-and-structure#the-core-components)The Core Components
...
## [](https://huggingface.co/learn/agents-course/en/unit1/agent-steps-and-structure#the-thought-action-observation-cycle)The Thought-Action-Observation Cycle
...
## [](https://huggingface.co/learn/agents-course/en/unit1/agent-steps-and-structure#alfred-the-weather-agent)Alfred, the weather Agent
...
### [](https://huggingface.co/learn/agents-course/en/unit1/agent-steps-and-structure#thought)Thought
...
### [](https://huggingface.co/learn/agents-course/en/unit1/agent-steps-and-structure#action)Action
...
### [](https://huggingface.co/learn/agents-course/en/unit1/agent-steps-and-structure#observation)Observation
...
### [](https://huggingface.co/learn/agents-course/en/unit1/agent-steps-and-structure#updated-thought)Updated thought
...
### [](https://huggingface.co/learn/agents-course/en/unit1/agent-steps-and-structure#final-action)Final Action
