...
## [](https://huggingface.co/learn/agents-course/en/unit1/what-are-llms#what-is-a-large-language-model)What is a Large Language Model?
...
## [](https://huggingface.co/learn/agents-course/en/unit1/what-are-llms#understanding-next-token-prediction)Understanding next token prediction.
...
## [](https://huggingface.co/learn/agents-course/en/unit1/what-are-llms#attention-is-all-you-need)Attention is all you need
...
## [](https://huggingface.co/learn/agents-course/en/unit1/what-are-llms#prompting-the-llm-is-important)Prompting the LLM is important
...
## [](https://huggingface.co/learn/agents-course/en/unit1/what-are-llms#how-are-llms-trained)How are LLMs trained?
...
## [](https://huggingface.co/learn/agents-course/en/unit1/what-are-llms#how-can-i-use-llms)How can I use LLMs?
...
## [](https://huggingface.co/learn/agents-course/en/unit1/what-are-llms#how-are-llms-used-in-ai-agents)How are LLMs used in AI Agents?
...
To run [this notebook](https://huggingface.co/agents-course/notebooks/blob/main/unit1/dummy_agent_library.ipynb), **you need a Hugging Face token** that you can get from [https://hf.co/settings/tokens](https://hf.co/settings/tokens).
